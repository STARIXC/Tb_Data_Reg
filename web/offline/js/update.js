            ...
            rules: {
                ...
                county: {
                    required: function (element) {
                        return $("#facility").val() === '' || $("#facility").val() === null;
                    }
                },
                 subcounty: {
                    required: function (element) {
